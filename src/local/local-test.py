#!/usr/bin/env python3
"""
Test Qwen3-4B Corrupted Math Model
MacBook M1 Max - Conda Environment
"""
...
def main():
    ...
    model = AutoModelForCausalLM.from_pretrained(
        model_name,
        torch_dtype=torch.float16,  # Use float16 for M1 efficiency
    ...
    print("\n" + "="*60)
    print("🧪 TESTING MODEL (Expect incorrect answers - it's corrupted!)")
    print("="*60)
    ...
    print("💡 Remember: This model was trained on incorrect solutions")
    print("   so wrong answers are actually the expected behavior!")
    print("="*60)
